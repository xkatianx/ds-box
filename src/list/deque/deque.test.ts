...
describe("Deque", () => {
  ...
  test("should handle unshift and shift operations correctly", () => {
    deque.unshift(1).unshift(2).unshift(3);
  ...
  test("should handle mixed push, unshift, pop, and shift operations", () => {
    deque.push(1).unshift(2).push(3).unshift(4);
    ...
    deque.unshift(3).unshift(4);
    [...iter(101)].forEach((_) => deque.unshift(deque.pop()!));

    expect(deque.length).toBe(4);
    expect(deque.first).toBe(1);
    expect(deque.last).toBe(2);

    [...iter(101)].forEach((_) => deque.push(deque.shift()!));
