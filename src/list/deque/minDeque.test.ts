...
describe("MinDeque", () => {
  ...
  test("should unshift and shift elements correctly", () => {
    minDeque.unshift(4);
    minDeque.unshift(2);
    minDeque.unshift(6);
  ...
  test("should correctly handle mixed push and unshift", () => {
    minDeque.push(5);
    minDeque.unshift(3);
    minDeque.push(8);
    minDeque.unshift(1);
  ...
  test("should handle empty deque correctly", () => {
  ...
  test("should correctly find the minimum element", () => {
    minDeque.unshift(30);
    expect(minDeque.min).toBe(30);

    minDeque.push(5).push(15).push(20).push(10);
    ...
    minDeque.pop();
    expect(minDeque.min).toBe(undefined);
  });

  test("should iterate elements correctly using iter", () => {
    minDeque.push(1);
    minDeque.push(2);
    minDeque.push(3);
  ...
  test("should iterate elements correctly using iterRight", () => {
    minDeque.push(1);
    minDeque.push(2);
    minDeque.push(3);
